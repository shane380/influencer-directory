...
.ni-headline { font-family: 'Playfair Display', serif; font-size: 38px; font-weight: 300; color: #111; line-height: 1.02; margin-bottom: 22px; }
...
.ni-term-secondary { font-size: 11.5px; color: #777; font-weight: 300; margin-top: 2px; }
...
.ni-footnote { font-size: 12px; color: #777; font-style: italic; line-height: 1.8; margin: 18px 0 32px; padding-left: 14px; border-left: 1.5px solid #e8e8e8; }

/* PERKS */
.ni-perk-row { display: flex; align-items: center; gap: 14px; padding: 11px 0; border-bottom: 1px solid #e8e8e8; font-family: 'Playfair Display', serif; font-size: 16px; color: #1a1a1a; line-height: 1.3; }
...
.ni-m-headline { font-family: 'Playfair Display', serif; font-size: 38px; font-weight: 300; color: #111; line-height: 1.02; }
...
.ni-m-term-secondary { font-size: 11.5px; color: #777; font-weight: 300; margin-top: 2px; text-align: right; }
...
.ni-m-footnote { font-size: 12px; color: #777; font-style: italic; line-height: 1.75; margin: 16px 0 26px; padding-left: 12px; border-left: 1.5px solid #e8e8e8; }
.ni-m-perk-row { display: flex; align-items: center; gap: 14px; padding: 11px 0; border-bottom: 1px solid #e8e8e8; font-family: 'Playfair Display', serif; font-size: 16px; color: #1a1a1a; line-height: 1.3; }
